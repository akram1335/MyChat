...
public class friends_request_fragmentclass extends Fragment {
   private RecyclerView mFriendsList;
    ...
    public friends_request_fragmentclass() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return inflater.inflate(R.layout.fragment_friends_request, container, false);
        ...
        mMainView = inflater.inflate(R.layout.fragment_friends_request, container, false);
    ...
    public void onStart() {
        super.onStart();
                    ...
                    FirebaseRecyclerAdapter<Users, FriendsViewHolder> friendsRecyclerViewAdapter = new FirebaseRecyclerAdapter<Users, friends_request_fragmentclass.FriendsViewHolder>(

                 Users.class,
                R.layout.user_item_layout,
                friends_request_fragmentclass.FriendsViewHolder.class,
                mFriendsDatabase


        ) {
            @Override
            protected void populateViewHolder(final friends_request_fragmentclass.FriendsViewHolder friendsViewHolder, Users users, int i) {


                friendsViewHolder.setUserStatus(users.getStatus());
