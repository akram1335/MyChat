...
public class home_fragmentclass extends Fragment {
            ...
            protected void populateViewHolder(final ConvViewHolder convViewHolder, final Conv conv, int i) {
                ...
                lastMessageQuery.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        convViewHolder.setMessage(data,msg_type, conv.isSeen());
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setMessage(String message,String msg_type, boolean isSeen){

            TextView userStatusView = (TextView) mView.findViewById(R.id.user_single_status);

            if(!msg_type.equals("text")){
                userStatusView.setText(" you have recieved an attachment");
            }else{
